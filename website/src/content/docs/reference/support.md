...
For most questions, checking the docs or opening a Discussion is the fastest path to an answer.
...
**What if my question is already covered in the docs?**
Community support via GitHub Issues or Discussions is the right path for publicly documented topics. Commercial support is most useful for private, team-specific integration or review scenarios.
