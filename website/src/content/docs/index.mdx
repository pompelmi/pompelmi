---
title: Pompelmi
description: File upload malware scanning for Node.js (Express/Koa/Next.js/Nuxt) with ZIP deep-inspection, MIME/size guards & optional YARA.
---
...
- **Server** — Lightweight middlewares for **Express/Koa** and helpers for **Next.js/Nuxt API routes**.
...
- Tutorial: **[Getting started](./tutorials/quick-start/)** (≈ 5 min)
- How‑to: **[Next.js](./how-to/nextjs/)** · **[Express](./how-to/express/)** · **[Koa](./how-to/koa/)** · **[Nuxt/Nitro](./how-to/nuxt-nitro/)** · **[Fastify](./how-to/fastify/)**
