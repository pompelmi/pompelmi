...
Use the canonical [Next.js guide](/pompelmi/how-to/nextjs/) for the shortest integration path. If you need object-storage patterns, go straight to [secure S3 presigned uploads with malware scanning](/pompelmi/tutorials/secure-s3-presigned-uploads-with-malware-scanning/). For examples and package sources, start at the [GitHub repo](https://github.com/pompelmi/pompelmi).
