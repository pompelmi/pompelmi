...
describe("Reason Codes", () => {
  ...
  describe("inferReasonCode", () => {
    ...
    it("should infer YARA match", () => {
      expect(inferReasonCode("YARA rule matched: evil.malware")).toBe(
    ...
    it("should infer archive bomb", () => {
      ...
      expect(inferReasonCode("archive bomb characteristics")).toBe(
    ...
    it("should infer path traversal", () => {
      ...
      expect(inferReasonCode("traversal detected in archive")).toBe(
