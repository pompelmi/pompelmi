...
import type { YaraCompiled, YaraMatch } from "../yara/index";
import { createYaraScannerFromFile, createYaraScannerFromRules } from "../yara/index";
...
function computeVerdict(matches: YaraMatch[]): NodeYaraVerdict {
  ...
  for (const m of matches) {
    ...
    const hasHighSeverity = tags.some(
      (t) =>
        t === "severity:high" ||
        t === "sev:high" ||
