...
**Translations:** [English](../../README.md) | [Italiano](README.it.md) | [Français](README.fr.md) | [Español](README.es.md) | [Deutsch](README.de.md) | [日本語](README.ja.md) | [简体中文](README.zh-CN.md) | [한국어](README.ko.md) | [Português (BR)](README.pt-BR.md) | [Русский](README.ru.md) | **Türkçe**

</div>

---

> 💡 **Çeviri Notu:** Bu belge İngilizce ana README dosyasının Türkçe çevirisidir. Teknik terimler ve kod örnekleri orijinal halinde bırakılmıştır.
...
<strong>Node.js için hızlı dosya yükleme zararlı yazılım taraması</strong> — isteğe bağlı <strong>YARA</strong> entegrasyonu, ZIP derinlemesine inceleme ve <em>Express</em>, <em>Koa</em> ve <em>Next.js</em> için hazır adaptörler. Tasarımdan gelen gizlilik. Tip güvenli. Küçük boyut.
</p>

**Anahtar Kelimeler:** dosya yükleme güvenliği · zararlı yazılım tespiti · YARA · Node.js middleware · Express · Koa · Next.js · ZIP bomba koruması
