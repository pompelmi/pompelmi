...
**运行在 Serverless 环境或无法安装 ClamAV？**  
使用 **[RapidAPI 官方托管 API](https://rapidapi.com/SonoTommy/api/pompelmi-malware-scanner)** →

✅ **零配置** • 无需安装二进制文件  
✅ **Serverless 就绪** • 适用于 AWS Lambda、Vercel、Netlify  
✅ **自动扩展** • 无 RAM/CPU 开销  
✅ **内置保护** • 自动 ZIP 炸弹检测

[**→ 在 RapidAPI 上开始使用**](https://rapidapi.com/SonoTommy/api/pompelmi-malware-scanner)
